                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Preview SPPD</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="col-lg-12">
            <div class="panel panel">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Preview SPPD</h3>
                </div>
                <div class="panel-body">
                    ...
                    <?php
                    $id = $_GET['id'];
                    $data = mysqli_query($koneksi, "SELECT * FROM perjadin,petugas WHERE sppd_petugas=petugas_id and sppd_id='$id'");
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <table class="table">
                                    <tr>
                                        <th>Kode Arsip</th>
                                        <td><?php echo $d['sppd_nomor']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Waktu Upload</th>
                                        <td><?php echo date('H:i:s  d-m-Y', strtotime($d['sppd_upload'])) ?></td>
                                    </tr>
                                    <tr>
                                        <th>Nama File</th>
                                        <td><?php echo $d['sppd_kegiatan']; ?></td>
                                    </tr>
                                    <!-- <tr>
                                        <th>Kategori</th>
                                    ...
                                    <tr>
                                        <th>Keterangan</th>
                                        <td><?php echo $d['sppd_keterangan']; ?></td>
                                    </tr>
                                </table>
