        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="white-box analytics-info-cs res-mg-t-30 table-mg-t-pro-n">
                    <h3 class="box-title">Jumlah Mitra</h3>
                    <ul class="list-inline two-part-sp">
                        <li>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="caption pro-sl-hd">
                                    <span class="caption-subject"><b>Grafik</b></span>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="actions graph-rp graph-rp-dl">
                                    <p>Grafik selama sebulan</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="single-cards-item">
                    ...
                    <div class="single-product-text">
                        ...
                        <h5>Pegawai</h5>
                        <p class="ctn-cards">Pengelolaan jadi lebih mudah dengan sistem informasi ...</p>
                    </div>
                </div>
